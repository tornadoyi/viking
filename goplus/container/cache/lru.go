...
// EvictCallback should be executed when an item removed from cache
func (c *LRU) SetEvictCallback(onEvict EvictCallback) { c.onEvict = onEvict }
...
func (c *LRU) PeekLatest() (key interface{}, value interface{}, ok bool) {
...
func (c *LRU) PeekOldest() (key interface{}, value interface{}, ok bool) {
